...
?>
    <div class="col-lg-12">
        ...
        <p><b>Client&nbsp;:</b>&nbsp;tout professionnel ou personne physique capable au sens des articles 1123 et suivants du Code civil, ou personne morale, qui visite le Site objet des présentes conditions générales.<br>
            <b>Prestations et Services&nbsp;:</b> <a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a> met à disposition des Clients&nbsp;:</p>

        <p><b>Contenu&nbsp;:</b>&nbsp;Ensemble des éléments constituants l’information présente sur le Site, notamment textes – images – vidéos.</p>

        <p><b>Informations clients&nbsp;:</b> Ci après dénommé «&nbsp;Information (s)&nbsp;» qui correspondent à l’ensemble des données personnelles susceptibles d’être détenues par <a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a> pour la gestion de votre compte, de la gestion de la relation client et à des fins d’analyses et de statistiques.</p>
        ...
        </p><p><strong>Propriétaire</strong> :   Besnard Arnaud   – 24 cité de la chaumière 56240 Plouay<br>

            <strong>Responsable publication</strong> : Arnaud Besnard – besnard.arno@gmail.com<br>
            Le responsable publication est une personne physique ou une personne morale.<br>
            <strong>Webmaster</strong> : Arnaud Besnard – contact@arnaudbesnard.fr<br>
            <strong>Hébergeur</strong> : 1and1 – 7 Place de la Gare 57200 Sarreguemines 0970 808 911<br>
            <strong>Délégué à la protection des données</strong> : Arnaud Besnard – besnard.arno@gmail.com<br>
        </p>

        <div ng-bind-html="linkHTML"><p>Ces mentions légales gratuites sont offertes par  Orson.io la solution pour <a href="https://fr.orson.io/94/creer-mon-site-internet-professionnel" title="réaliser un site internet bien référencé sur Google. ">réaliser un site internet bien référencé sur Google. </a></p></div>
        ...
        <p>Le site internet&nbsp;<a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a>&nbsp;a pour objet de fournir une information concernant l’ensemble des activités de la société.
        ...
        <p>Le site utilise la technologie JavaScript.
            ...
            Le site <a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a> est hébergé chez un prestataire sur le territoire de l’Union Européenne conformément aux dispositions du Règlement Général sur la Protection des Données (RGPD&nbsp;: n° 2016-679)</p>
        ...
        <p><a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a> est propriétaire des droits de propriété intellectuelle et détient les droits d’usage sur tous les éléments accessibles sur le site internet, notamment les textes, images, graphismes, logos, vidéos, icônes et sons.
            Toute reproduction, représentation, modification, publication, adaptation de tout ou partie des éléments du site, quel que soit le moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable de : <a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a>.</p>

        <p>Toute exploitation non autorisée du site ou de l’un quelconque des éléments qu’il contient sera considérée comme constitutive d’une contrefaçon et poursuivie conformément aux dispositions des articles L.335-2 et suivants du Code de Propriété Intellectuelle.</p>

        <h2>6. Limitations de responsabilité.</h2>

        <p><a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a> agit en tant qu’éditeur du site. <a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a> &nbsp;est responsable de la qualité et de la véracité du Contenu qu’il publie. </p>
        ...
        <p>Pour les Données Personnelles collectées dans le cadre de la création du compte personnel de l’Utilisateur et de sa navigation sur le Site, le responsable du traitement des Données Personnelles est : Besnard Arnaud. <a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a>est représenté par Arnaud Besnard, son représentant légal</p>
        ...
        &nbsp;
        <p><a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a> est susceptible de traiter tout ou partie des données : </p>
        ...
        <ul>
            ...
            &nbsp;
            <li>pour mener des enquêtes de satisfaction facultatives sur <a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a> : adresse email </li>
            <li>pour mener des campagnes de communication (sms, mail) : numéro de téléphone, adresse email</li>


        </ul>

        <p><a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a> ne commercialise pas vos données personnelles qui sont donc uniquement utilisées par nécessité ou à des fins statistiques et d’analyses.</p>
        &nbsp;
        <h3>7.3 Droit d’accès, de rectification et d’opposition</h3>
        &nbsp;
        <p>
            Conformément à la réglementation européenne en vigueur, les Utilisateurs de <a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a> disposent des droits suivants : </p>
        &nbsp;<ul>
            ...
            &nbsp;
            <li>droit de définir le sort des données des Utilisateurs après leur mort et de choisir à qui <a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a> devra communiquer (ou non) ses données à un tiers qu’ils aura préalablement désigné</li>
            &nbsp;</ul>
        ...
        &nbsp;
        Besnard Arnaud – DPO, Arnaud Besnard <br>
        24 cité de la chaumière 56240 Plouay.
        &nbsp;
        <p>Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles qu’il souhaiterait que <a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a> corrige, mette à jour ou supprime, en s’identifiant précisément avec une copie d’une pièce d’identité (carte d’identité ou passeport). </p>
        ...
        <p>
            Les Données Personnelles de l’Utilisateur peuvent être traitées par des filiales de <a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a> et des sous-traitants (prestataires de services), exclusivement afin de réaliser les finalités de la présente politique.</p>
        <p>
        ...
        &nbsp;
        <p>
            Lors du traitement des Données Personnelles, <a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a>prend toutes les mesures raisonnables visant à les protéger contre toute perte, utilisation détournée, accès non autorisé, divulgation, altération ou destruction.</p>
        &nbsp;
        ...
        <p>
            Tout litige en relation avec l’utilisation du site&nbsp;<a href="http://projet4.arnaudbesnard.fr">http://projet4.arnaudbesnard.fr</a>&nbsp;est soumis au droit français.
            En dehors des cas où la loi ne le permet pas, il est fait attribution exclusive de juridiction aux tribunaux compétents de Plouay</p>
