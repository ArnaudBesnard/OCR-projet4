...
$message_html = "<html><head></head><body><b>Bonjour</b>, voici le lien pour réinitialiser votre mot de passe : <br /><a href=\"http://localhost/ocr-projet4/index.php?page=newPwd&&login=$login\">Cliquez ici</a></body></html>";
//==========
