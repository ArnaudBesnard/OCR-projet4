...
<nav class="menuAdmin">
    <ul class="nav flex-column">
        ...
        <li><a href="index.php?action=adminComment"><i style="font-size:18px" class="fa">&#xf00c;</i> Validation (<?= $manager->countComment(); ?>)</a></li>
        <li><a href="index.php?action=viewReport"><i style="font-size:18px" class="fa">&#xf0f3;</i> Modéreration (<?= $manager->countReporting(); ?>)</a></li>
    </ul>
</nav>