...
<nav class="menuAdmin">
    <ul class="nav flex-column">
        ...
        <li><a href="index.php?page=addPost"><i style="font-size:18px" class="fa">&#xf055;</i> Ajout d'un billet</a></li>
        <li><a href="index.php?page=administration"><i style="font-size:18px" class="fa">&#xf0ad;</i> Gestion des billets</a></li>
